...
// case sensetive thapa=!Thapa
//it means forward search karta hai

// var myFriendNames = ["vinod","bahadur","thapa","thapatechnical"];

// console.log(myFriendNames.includes("thapa",2));
...
// find return undefined if Element not found and findIndex return -1 if Element not fonund
...
//removes the last element from array and return it.
// if the array is empty and we perform pop then undefined is return
...
// THIS METHOD WE NORMALLY USE FOR DELETE SO THAT IT RETURN AND DELETED ELEMENT ,
// IF WE WANT TO DELETE AND ADD ELEMENT IN THE DELETED  PLACE THAT TIME IT RETURN AND EMPTY ARRAY
...
// ex: document.body.hasChildNodes() => gives true or false as an answer
...
//Namaste JavaScript 
// Scope: Where you can access specific variable or a function in a code.
